...
export function matToFloat32Array(m) {
 ...
 * @returns 
 */
export function translate4x4(tx, ty, tz) {
	let trans = mat4();
...
export function vector_scale(u, s){
	let temp = []
...
export function cross_product(u, v) {
    if (!Array.isArray(u) || u.length < 3) {
...
export function vector_add(u,v) {
	if (u.length != v.length){
