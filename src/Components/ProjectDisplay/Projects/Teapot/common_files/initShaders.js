...
export function getVertexShader(vertexShaderId, gl){
	var vertShdr;
...
export function getFragmentShader(fragmentShaderId,gl){
	var fragShdr;
...
export function initShaders( gl, vertShdr, fragShdr) {
