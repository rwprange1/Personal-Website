...
import { numTeapotPatches, indices } from "./patches";

import {vec2, vec3, vec4, add, cross, normalize, matToFloat32Array} from "./MV"
...
export function createTeapotGeometry (numDivisions) {
