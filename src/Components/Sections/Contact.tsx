...
function getInTouch(){
    ...
    return(
        <div className="flex flex-col lg:flex-row pt-5 pb-0 gap-8 ">
            <div className="flex flex-col text-3xl text-neutral-600 dark:text-gray-300 break-words w-full lg:w-1/2 outline-2 outline-zinc-700 rounded-2xl p-2 h-1/2">
