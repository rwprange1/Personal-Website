...
function Skills(){
    ...
    return(
        <div className="rounded-2xl  content-center text-white">
            <h1 className='rounded-full  justify-center  flex space-x-3 text-4xl text-gray-300 '>
                <text> Skills  </text>
            </h1>
            <div className="flex flex-col lg:flex-row p-2 gap-8 content-center justify-center">
                {/** Box 1 */}
            <div className="flex flex-col lg:flex-row  gap-8 rounded-2xl outline-zinc-700 outline-2 w-1/2">
            <div className="flex flex-col text-lg  break-words w-full ">
                <strong className="self-center text-3xl p-2 text-gray-500"> Languages</strong> 
            ...
            <div className="flex flex-col text-lg  break-words w-full ">
                <strong className="self-center text-3xl text-gray-500 p-2"> Frameworks</strong> 
        ...
        <div className="flex flex-col lg:flex-row gap-8 rounded-2xl outline-zinc-700 outline-2 w-1/2">
            <div className="flex flex-col text-lg  break-words w-full ">
                <strong className="self-center text-3xl  text-gray-500  p-2"> Databases</strong> 
                <ul className="self-center space-y-1 text-white list-inside  ">
                    <li>
                        <div className="rounded-full flex space-x-2 pb-2">
                            <DiMysql size="1.5em"/>
            ...
            <div className="flex flex-col text-lg  w-full ">
                <strong className="self-center text-gray-500 text-3xl p-2"> Other Tools</strong> 
                <ul className="self-center space-y-1 text-white  list-inside  ">
                    <li>
                        <div className="rounded-full flex space-x-2 pb-2">
