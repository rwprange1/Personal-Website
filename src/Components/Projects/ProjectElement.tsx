...
function ProjectElement(props: ProjectElementProps){
    ...
    return(
        <div className="items-center w-2/3 lg:w-1/3 max-w-md   h-[500px] flex flex-col  bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 overflow-y-scroll">
